...
def Helix2DistRestraints(start, end, sequence):
	...
	for j in range(start+1, end-4+1):
		...
		## for C atoms
		if j+5 < end+1:
			command = "assign (resid %3d and name  C) (resid %3d and name  C) 8.16 0.10 0.10 !helix".format(j,j+5)
			lines.append(command)
                command = "assign (resid %3d and name  C) (resid %3d and name  C) 4.87 0.10 0.10 !helix".format(j,j+3)
		lines.append(command)
                command = "assign (resid %3d and name  C) (resid %3d and name  C) 6.09 0.10 0.10 !helix".format(j,j+4)
		lines.append(command) 

		## for CA atoms
		if j+5 < end+1:
                	command = "assign (resid %3d and name CA) (resid %3d and name CA) 8.63 0.10 0.10 !helix".format(j,j+5)
			lines.append(command)
                command = "assign (resid %3d and name CA) (resid %3d and name CA) 5.13 0.10 0.10 !helix".format(j,j+3)
		lines.append(command)
                command = "assign (resid %3d and name CA) (resid %3d and name CA) 6.16 0.10 0.10 !helix".format(j,j+4)
		lines.append(command)

		## for N atoms
		if j+5 < end+1:
                	command = "assign (resid %3d and name  N) (resid %3d and name  N) 8.07 0.10 0.10 !helix".format(j,j+5)
			lines.append(command)
                command = "assign (resid %3d and name  N) (resid %3d and name  N) 4.84 0.10 0.10 !helix".format(j,j+3)
		lines.append(command)
                command = "assign (resid %3d and name  N) (resid %3d and name  N) 6.10 0.10 0.10 !helix".format(j,j+4)
		lines.append(command)

		## for O atoms
		if j+5 < end+1:
                	command = "assign (resid %3d and name  O) (resid %3d and name  O) 8.40 0.10 0.10 !helix".format(j,j+5)
			lines.append(command)
                command = "assign (resid %3d and name  O) (resid %3d and name  O) 4.99 0.10 0.10 !helix".format(j,j+3)
		lines.append(command)
                command = "assign (resid %3d and name  O) (resid %3d and name  O) 6.12 0.10 0.10 !helix".format(j,j+4)
		lines.append(command)
...
def Beta2DistRestraints(start, end, sequence):
	...
	for j in range(start+1, end):
		command = "assign (resid %3d and name  O) (resid %3d and name  O) 4.57 0.10 0.10 !unpaired E residue".format(j, j+1)
		lines.append(command)
...
def Helix2HBond(start, end, sequence):
	...
	for j in range(start+1, end-4+1):
		...
		if sequence[j+3] == 'P':
			command = "assign (resid %3d and name O) (resid %3d and name N) 2.99  0.1  0.1 !helix".format(j, j+4)
		else:
			command = "assign (resid %3d and name O) (resid %3d and name N) 1.99  0.1  0.1 !helix".format(j, j+4)
