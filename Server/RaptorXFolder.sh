...
function Usage()
{
	...
	echo "		If you want to fold a larger protein, you may set a larger value through this option"
	echo "		However, bear in mind that when relaxation is done, it may take ~10 hours and ~10G CPU memory to build a single 3D model for such a large protein"
	echo " "
