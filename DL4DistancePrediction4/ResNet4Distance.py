...
class ResNet:
    def __init__(self, rng, input, n_in, halfWinSize=0, mask=None, n_hiddens=None, n_repeats=None, activation=T.nnet.relu, dim_inc_method='partial_projection', batchNorm=True, version='ResNetv2'):
	"""
